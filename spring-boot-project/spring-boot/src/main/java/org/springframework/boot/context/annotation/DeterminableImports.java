...
public interface DeterminableImports {
	...
	/**
	 * 返回一组表示导入的对象。retur中的对象 Return a set of objects that represent the imports. Objects
	 * within the returned {@code Set} must implement a valid {@link Object#hashCode()
	 * hashCode} and {@link Object#equals(Object) equals}.
	 * <p>
